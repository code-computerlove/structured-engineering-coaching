...
namespace Checkout
{
    ...
    buy n of them, and they�ll cost you y pence. For example, item A might cost
    50 individually, but this week we have a special offer: buy three As and
    they�ll cost you 130. In fact the prices are:
    ...
    and another B, we�ll recognize the two Bs and price them at 45
